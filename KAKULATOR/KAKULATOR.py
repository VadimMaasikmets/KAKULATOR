...
entry_a = Entry(root, width=5, font=('Arial', 16), bg='lightblue')
entry_a.place(x=20, y=100, width=120, height=30)
entry_b = Entry(root, width=5, font=('Arial', 16), bg='lightblue')
entry_b.place(x=220, y=100, width=120, height=30)
entry_c = Entry(root, width=5, font=('Arial', 16), bg='lightblue')
entry_c.place(x=420, y=100, width=120, height=30)

label_a = Label(root, text="x² +", bg='white', font='Arial 16')
label_a.place(x=150, y=100)
label_b = Label(root, text="x +", bg='white', font='Arial 16')
label_b.place(x=350, y=100)
label_c = Label(root, text="= 0", bg='white', font='Arial 16')
label_c.place(x=550, y=100)

dasha_button = Button(root, text="Решить", command=dasha, bg='green', font='Arial 16')
dasha_button.place(x=480, y=150, width=100, height=40)

solution_frame = Frame(root, bg='yellow', height=50)
solution_frame.pack(padx=20, pady=10, fill='x', expand=True)
solution_title = Label(solution_frame, text='Решение', bg='yellow', font='Arial 12')
solution_title.pack(side='top', fill='x')
solution_text = Label(solution_frame, text='', bg='yellow', font='Arial 12', anchor='w')
